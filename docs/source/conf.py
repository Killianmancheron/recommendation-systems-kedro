...
# recommendation_systems documentation build
...
from recommendation_systems import __version__ as release
...
htmlhelp_basename = "recommendation_systemsdoc"
...
latex_documents = [
    (
        master_doc,
        "recommendation_systems.tex",
        "recommendation_systems Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "recommendation_systems",
        "Project recommendation_systems codebase.",
        "Data-Science",
    )
]
